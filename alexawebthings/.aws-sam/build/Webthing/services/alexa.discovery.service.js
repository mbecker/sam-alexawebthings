...
var webthing_model_1 = require("./../models/webthing.model");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    options = {
                        method: 'get',
                        url: process.env.WEBTHING_SERVER_URL + "/things",
                        headers: {
                            'Accept': 'application/json',
                            'Authorization': "Bearer " + process.env.WEBTHING_TOKEN
                        }
                    };
                    _a.label = 1;
                case 1:
                ...
                case 2:
                    ...
                    return [2 /*return*/, new webthing_model_1.AlexaThings(response.data)];
                case 3:
                    err_1 = _a.sent();
                    throw err_1;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    options = {
                        method: 'get',
                        url: process.env.WEBTHING_SERVER_URL + "/things/" + endpointID + "/properties",
                        headers: {
                            'Accept': 'application/json',
                            'Authorization': "Bearer " + process.env.WEBTHING_TOKEN
                        }
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    options = {
                        method: 'put',
                        url: process.env.WEBTHING_SERVER_URL + "/things/" + endpointID + "/properties/" + propertyKey,
                        headers: {
                            'Accept': 'application/json',
...
//# sourceMappingURL=alexa.discovery.service.js.map